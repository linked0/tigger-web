...
import { ChainId, WDEV } from 'tigger-swap-sdk'
...
function useContractWithLibrary(
...
export function useTokenContractWithLibrary(
  library: any,
  tokenAddress?: string,
  withSignerIfPossible?: boolean
): Contract | null {
  return useContractWithLibrary(tokenAddress, ERC20_ABI, library, withSignerIfPossible)
}
