...
import { TokenAmount, Token, ChainId, Percent, JSBI } from "tigger-swap-sdk";
...
describe("utils", () => {
  describe("#getEtherscanLink", () => {
    ...
    it("sepolia", () => {
      expect(getEtherscanLink(11155111, "abc", "address")).toEqual("https://sepolia.etherscan.io/address/abc");
    });
    it("enum", () => {
