import { ChainId, JSBI, Pair, Route, Token, TokenAmount, Trade, TradeType } from "tigger-swap-sdk";
...
describe("prices", () => {
  ...
  describe("computeTradePriceBreakdown", () => {
    ...
    it("correct realized lp fee for single hop", () => {
      ...
      ).toEqual(new TokenAmount(token1, JSBI.BigInt(15)));
    });
    ...
    it("correct realized lp fee for double hop", () => {
      ...
      ).toEqual(new TokenAmount(token1, JSBI.BigInt(29)));
    });
  });
});
